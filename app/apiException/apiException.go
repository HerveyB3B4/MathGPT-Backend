...
var (
	...
	NoThatUserOrPasswordWrong = NewError(http.StatusInternalServerError, 200504, "用户名或密码错误")
	HttpTimeout               = NewError(http.StatusInternalServerError, 200505, "请求超时")
	RequestError              = NewError(http.StatusInternalServerError, 200506, "响应错误")
